...
namespace tui
{
    ...
    // Widget comparisons
    inline bool operator==(const Paragraph &paragraph1, const Paragraph &paragraph2)
    {
        return (
    ...
    inline bool operator==(const List &list1, const List &list2)
    {
        return (
    ...
    inline bool operator==(const BarChart &bar_chart1, const BarChart &bar_chart2)
    {
        return (
    ...
    inline bool operator==(const Gauge &gauge1, const Gauge &gauge2)
    {
        return (
    ...
    template <>
    inline void Window::add(Paragraph paragraph)
    {
    ...
    template <>
    inline void Window::add(List list)
    {
        if (list.border == true)
        {
            draw_border(list);
    ...
    template <>
    inline void Window::add(BarChart bar_chart)
    {
    ...
    template <>
    inline void Window::add(Gauge gauge)
    {
    ...
    inline void Widget::set_dimensions(int x_, int y_, int width_, int height_)
    {
        x = x_;
        y = y_;
        width = width_;
    ...
    // Scroll up the list
    template <>
    inline void List::scroll_up(Window &window, int factor)
    {
    ...
    template <>
    inline void List::scroll_down(Window &window, int factor)
    {
        if (rows.size() > height - 2)
        {
